...
#include <memory>
#include "../../../../include/light_headers/Fixture.h"
...
Q_CONSTINIT static const qt_meta_stringdata_Mediator_t qt_meta_stringdata_Mediator = {
    {
        ...
        QT_MOC_LITERAL(26, 0),  // ""
        QT_MOC_LITERAL(27, 18),  // "UnselectingFixture"
        QT_MOC_LITERAL(46, 16),  // "SelectingCommand"
        QT_MOC_LITERAL(63, 18)   // "UnselectingCommand"
    },
    "Mediator",
    "SelectingFixture",
    "",
...
Q_CONSTINIT const QMetaObject Mediator::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_Mediator_t,
        ...
        // method 'UnselectingFixture'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'SelectingCommand'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'UnselectingCommand'
        QtPrivate::TypeAndForceComplete<void, std::false_type>
    >,
    nullptr
} };
...
void Mediator::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->UnselectingFixture(); break;
        case 2: _t->SelectingCommand(); break;
        case 3: _t->UnselectingCommand(); break;
        default: ;
        }
        ...
        {
            using _t = void (Mediator::*)();
            if (_t _q_method = &Mediator::UnselectingFixture; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        ...
        {
            using _t = void (Mediator::*)();
            if (_t _q_method = &Mediator::UnselectingCommand; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 3;
                return;
            }
        }
...
// SIGNAL 1
void Mediator::UnselectingFixture()
{
...
// SIGNAL 3
void Mediator::UnselectingCommand()
{
