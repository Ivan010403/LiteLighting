...
#include <memory>
#include "../../../../include/qt_headers/settings_panel/settingspanel.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_SettingsPanel_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_SettingsPanel_t qt_meta_stringdata_SettingsPanel = {
    {
        QT_MOC_LITERAL(0, 13)   // "SettingsPanel"
    },
    "SettingsPanel"
};
...
Q_CONSTINIT static const uint qt_meta_data_SettingsPanel[] = {
...
Q_CONSTINIT const QMetaObject SettingsPanel::staticMetaObject = { {
    ...
    qt_meta_stringdata_SettingsPanel.offsetsAndSizes,
    qt_meta_data_SettingsPanel,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_SettingsPanel_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<SettingsPanel, std::true_type>
    >,
    nullptr
} };
